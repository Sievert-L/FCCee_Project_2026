...
# check if EOS_SUBDIR is needed in copy command (if yes, check the name is correct)

set -e

# ---------------- USER SETTINGS ----------------
script_name=DA_MA_script_noBB.py
results_folder_name=Performance_scans_corrected_lattice_noBB
