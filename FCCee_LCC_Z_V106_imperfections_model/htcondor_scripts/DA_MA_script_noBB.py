...
# define the correct set of parameters for the case with or without collisions

#path = '/mnt/c/Users/laral/CERNBox' # if local
...
output_dir_name = f'OUTPUT_performance_scans/Performance_scans_corrected_lattice_noBB'
...
study_param['ini_cond_nemittance_y'] = 0.7e-12 * 89236
